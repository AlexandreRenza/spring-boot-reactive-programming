package com.renza.springbootreactiveprogramming.fluxandmono;
...
public class FluxAndMonoTest {
    ...
    public void FluxTest(){
        ...
        Flux<String> stringFlux = Flux.just("Spring", "Spring Boot", "Reactive Spring")
                                        ...
                                        .concatWith(Flux.just("After Error")) // after error flux wont send any more data
                                        .log();
    ...
    @Test
    public void fluxTestElements_New_WithError(){
